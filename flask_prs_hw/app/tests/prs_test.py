...
class PrsTest(unittest.TestCase):
    ...
    def test_play_game_to_tie(self):
        ...
        self.assertEqual("Both Douglas and Marko have chosen the same thing so it's a tie!", Prs.play_game(self, self.player_1, self.player_2))

    def test_play_game_to_victory_player_1(self):
        self.player_1 = Player("Sally", "Paper")
        self.player_2 = Player("John", "Rock")
        self.assertEqual("Paper wraps Rock. Sally wins!", Prs.play_game(self, self.player_1, self.player_2))

    def test_play_game_to_victory_player_2(self):
        self.player_1 = Player("Cain", "Scissors")
        self.player_2 = Player("Abel", "Rock")
        self.assertEqual("Rock crushes Scissors. Abel wins!", Prs.play_game(self, self.player_1, self.player_2))
